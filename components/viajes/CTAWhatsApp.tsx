...
export default function CTAWhatsApp() {
  ...
  return (
    ...
    >
      <p className="viajes-label" data-reveal style={{ opacity: 0, color: 'var(--viajes-sky)' }}>
        05 / Hablemos
      </p>
      ...
      <p className="viajes-body mt-8" data-reveal style={{ opacity: 0, color: 'rgba(242,240,233,0.75)' }}>
