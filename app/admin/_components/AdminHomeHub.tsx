...
function HubCard({ card, index }: { card: HubCardData; index: number }) {
    ...
    >
      ...
      >
        <motion.div
          ...
          className="relative h-full min-h-[220px] flex flex-col gap-6 bg-white rounded-[24px] border border-[#E5E5E5] p-7 sm:p-8 shadow-[0_2px_20px_-4px_rgba(0,0,0,0.05)] group-hover:shadow-[0_16px_36px_-10px_rgba(47,74,0,0.16)] group-hover:border-[#D9EFB0] transition-[box-shadow,border-color] duration-300 overflow-hidden"
        >
          {isDesktop && (
            <motion.div
          ...
          <div className="relative z-10 w-12 h-12 rounded-2xl bg-gradient-to-br from-[#F2FBDD] to-[#E4F5C6] flex items-center justify-center shrink-0">
