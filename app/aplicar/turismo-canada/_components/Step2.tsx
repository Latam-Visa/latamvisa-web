      ...
      <div className="bg-[#F5F5F0] p-6 rounded-xl border border-[#E5E5E5] space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <FormField label="Apellidos (como en el pasaporte)" name="step2.surname" required error={errors.step2?.surname?.message as string}>
            <input {...register('step2.surname')} className="w-full bg-white border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] focus:ring-2 focus:ring-[#2F4A00] transition-colors" />
          </FormField>
          <FormField label="Nombres (como en el pasaporte)" name="step2.given_name" error={errors.step2?.given_name?.message as string}>
            <input {...register('step2.given_name')} className="w-full bg-white border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] focus:ring-2 focus:ring-[#2F4A00] transition-colors" />
          </FormField>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <FormField label="Fecha de nacimiento" name="step2.date_of_birth" required error={errors.step2?.date_of_birth?.message as string}>
            <input type="date" {...register('step2.date_of_birth')} className="w-full bg-white border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] focus:ring-2 focus:ring-[#2F4A00] transition-colors [color-scheme:light]" />
          </FormField>
          <FormField label="Género" name="step2.gender" required error={errors.step2?.gender?.message as string}>
            <select {...register('step2.gender')} className="w-full bg-white border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] focus:ring-2 focus:ring-[#2F4A00] transition-colors appearance-none">
      ...
      <div className="bg-[#F5F5F0] p-6 rounded-xl border border-[#E5E5E5] space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <FormField label="Tipo de documento" name="step2.document_type" required error={errors.step2?.document_type?.message as string}>
            <select {...register('step2.document_type')} className="w-full bg-white border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] focus:ring-2 focus:ring-[#2F4A00] transition-colors appearance-none">
          ...
          <FormField label="Categoría de pasaporte" name="step2.passport_kind" required error={errors.step2?.passport_kind?.message as string}>
            <select {...register('step2.passport_kind')} className="w-full bg-white border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] focus:ring-2 focus:ring-[#2F4A00] transition-colors appearance-none">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <FormField label="País que emitió el pasaporte" name="step2.passport_country_code" required error={errors.step2?.passport_country_code?.message as string}>
            <select {...register('step2.passport_country_code')} className="w-full bg-white border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] focus:ring-2 focus:ring-[#2F4A00] transition-colors appearance-none">
          ...
          <FormField label="Nacionalidad en el pasaporte" name="step2.passport_nationality" required error={errors.step2?.passport_nationality?.message as string}>
            <select {...register('step2.passport_nationality')} className="w-full bg-white border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] focus:ring-2 focus:ring-[#2F4A00] transition-colors appearance-none">
              <option value="">Seleccionar país</option>
              {ALL_COUNTRIES.map(c => <option key={c.code} value={c.code}>{c.flag} {c.name}</option>)}
            </select>
          </FormField>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <FormField label="Número de pasaporte" name="step2.passport_number" required error={errors.step2?.passport_number?.message as string}>
            <input {...register('step2.passport_number')} className="w-full bg-white border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] focus:ring-2 focus:ring-[#2F4A00] transition-colors uppercase" />
          </FormField>
          <FormField label="Confirmar número de pasaporte" name="step2.passport_number_confirm" required error={errors.step2?.passport_number_confirm?.message as string}>
            <input {...register('step2.passport_number_confirm')} className="w-full bg-white border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] focus:ring-2 focus:ring-[#2F4A00] transition-colors uppercase" />
          </FormField>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <FormField label="Fecha de emisión" name="step2.passport_issue_date" required error={errors.step2?.passport_issue_date?.message as string}>
            <input type="date" {...register('step2.passport_issue_date')} className="w-full bg-white border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] focus:ring-2 focus:ring-[#2F4A00] transition-colors [color-scheme:light]" />
          </FormField>
          <FormField label="Fecha de vencimiento" name="step2.passport_expiry_date" required error={errors.step2?.passport_expiry_date?.message as string}>
            <input type="date" {...register('step2.passport_expiry_date')} className="w-full bg-white border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] focus:ring-2 focus:ring-[#2F4A00] transition-colors [color-scheme:light]" />
          </FormField>
        </div>
      </div>
          ...
          <div className="bg-white p-6 rounded-xl border border-[#E5E5E5] space-y-4 animate-in fade-in slide-in-from-top-2">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <FormField label="Número de visa de USA" name="step2.us_visa_number" required error={errors.step2?.us_visa_number?.message as string}>
                <input {...register('step2.us_visa_number')} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors uppercase" />
              </FormField>
              <FormField label="Fecha de expiración de la visa" name="step2.us_visa_expiry" required error={errors.step2?.us_visa_expiry?.message as string}>
                <input type="date" {...register('step2.us_visa_expiry')} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors [color-scheme:light]" />
              </FormField>
            </div>
