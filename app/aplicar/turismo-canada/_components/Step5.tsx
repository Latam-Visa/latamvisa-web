      ...
      <div className="bg-[#F5F5F0] p-6 rounded-xl border border-[#E5E5E5] space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <FormField label="Dinero disponible para tu estancia en Canadá (CAD)" hint="Dólares Canadienses" name="step5.funds_cad" required error={errors.step5?.funds_cad?.message as string}>
            <input type="number" {...register('step5.funds_cad')} className="w-full bg-white border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] focus:ring-2 focus:ring-[#2F4A00] transition-colors" placeholder="Ej: 3000" />
          </FormField>
        </div>
              ...
              renderItem={(index) => (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <FormField label="Institución" name={`step5.education_history.${index}.school`} required error={(errors.step5?.education_history as any)?.[index]?.school?.message as string}>
                    <input {...register(`step5.education_history.${index}.school`)} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors" />
                  </FormField>
                  <FormField label="Campo de estudio" name={`step5.education_history.${index}.field`} required error={(errors.step5?.education_history as any)?.[index]?.field?.message as string}>
                    <input {...register(`step5.education_history.${index}.field`)} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors" />
                  </FormField>
                  <FormField label="Nivel académico" name={`step5.education_history.${index}.level`} required error={(errors.step5?.education_history as any)?.[index]?.level?.message as string}>
                    <input {...register(`step5.education_history.${index}.level`)} placeholder="Ej: Pregrado, Maestría" className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors" />
                  </FormField>
                  <FormField label="País" name={`step5.education_history.${index}.country`} required error={(errors.step5?.education_history as any)?.[index]?.country?.message as string}>
                    <select {...register(`step5.education_history.${index}.country`)} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors appearance-none">
                  ...
                  <FormField label="Ciudad" name={`step5.education_history.${index}.city`} required error={(errors.step5?.education_history as any)?.[index]?.city?.message as string}>
                    <input {...register(`step5.education_history.${index}.city`)} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors" />
                  </FormField>
                  <FormField label="Dirección" name={`step5.education_history.${index}.street`} required error={(errors.step5?.education_history as any)?.[index]?.street?.message as string}>
                    <input {...register(`step5.education_history.${index}.street`)} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors" />
                  </FormField>
                  <FormField label="Desde" name={`step5.education_history.${index}.from`} required error={(errors.step5?.education_history as any)?.[index]?.from?.message as string}>
                    <input type="date" {...register(`step5.education_history.${index}.from`)} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors [color-scheme:light]" />
                  </FormField>
                  <FormField label="Hasta" name={`step5.education_history.${index}.to`} required error={(errors.step5?.education_history as any)?.[index]?.to?.message as string}>
                    <input type="date" {...register(`step5.education_history.${index}.to`)} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors [color-scheme:light]" />
                  </FormField>
                </div>
              )}
            />
            ...
            return (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <FormField label="Actividad principal" name={`step5.work_history.${index}.activity`} required error={(errors.step5?.work_history as any)?.[index]?.activity?.message as string}>
                  <select {...register(`step5.work_history.${index}.activity`)} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors appearance-none">
                ...
                {!isUnemployed && (
                  <>
                    <FormField label="Cargo / Profesión" name={`step5.work_history.${index}.job_title`} required error={(errors.step5?.work_history as any)?.[index]?.job_title?.message as string}>
                      <input {...register(`step5.work_history.${index}.job_title`)} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors" />
                    </FormField>
                    <FormField label="Empleador / Empresa" name={`step5.work_history.${index}.employer`} required error={(errors.step5?.work_history as any)?.[index]?.employer?.message as string}>
                      <input {...register(`step5.work_history.${index}.employer`)} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors" />
                    </FormField>
                    <FormField label="Breve descripción de tareas" name={`step5.work_history.${index}.duties`} required error={(errors.step5?.work_history as any)?.[index]?.duties?.message as string}>
                      <input {...register(`step5.work_history.${index}.duties`)} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors" />
                    </FormField>
                  </>
                )}
                ...
                <FormField label="País" name={`step5.work_history.${index}.country`} required error={(errors.step5?.work_history as any)?.[index]?.country?.message as string}>
                  <select {...register(`step5.work_history.${index}.country`)} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors appearance-none">
                    <option value="">Seleccionar país</option>
                    {ALL_COUNTRIES.map(c => <option key={c.code} value={c.code}>{c.flag} {c.name}</option>)}
                  </select>
                </FormField>
                ...
                <FormField label="Ciudad" name={`step5.work_history.${index}.city`} required error={(errors.step5?.work_history as any)?.[index]?.city?.message as string}>
                  <input {...register(`step5.work_history.${index}.city`)} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors" />
                </FormField>
                ...
                {!isUnemployed && (
                  <FormField label="Dirección de trabajo" name={`step5.work_history.${index}.street`} required error={(errors.step5?.work_history as any)?.[index]?.street?.message as string}>
                    <input {...register(`step5.work_history.${index}.street`)} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors" />
                  </FormField>
                )}
                ...
                <FormField label="Desde" name={`step5.work_history.${index}.from`} required error={(errors.step5?.work_history as any)?.[index]?.from?.message as string}>
                  <input type="date" {...register(`step5.work_history.${index}.from`)} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors [color-scheme:light]" />
                </FormField>
              ...
              renderItem={(index) => (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <FormField label="País" name={`step5.military_details.${index}.country`} required error={(errors.step5?.military_details as any)?.[index]?.country?.message as string}>
                    <select {...register(`step5.military_details.${index}.country`)} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors appearance-none">
                      <option value="">Seleccionar país</option>
                      {ALL_COUNTRIES.map(c => <option key={c.code} value={c.code}>{c.flag} {c.name}</option>)}
                    </select>
                  </FormField>
                  <FormField label="Rama (Ej: Armada, Marina)" name={`step5.military_details.${index}.branch`} required error={(errors.step5?.military_details as any)?.[index]?.branch?.message as string}>
                    <input {...register(`step5.military_details.${index}.branch`)} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors" />
                  </FormField>
                  <FormField label="Rango" name={`step5.military_details.${index}.rank`} required error={(errors.step5?.military_details as any)?.[index]?.rank?.message as string}>
                    <input {...register(`step5.military_details.${index}.rank`)} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors" />
                  </FormField>
                  <FormField label="Desde" name={`step5.military_details.${index}.from`} required error={(errors.step5?.military_details as any)?.[index]?.from?.message as string}>
                    <input type="date" {...register(`step5.military_details.${index}.from`)} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors [color-scheme:light]" />
                  </FormField>
                  <FormField label="Hasta" name={`step5.military_details.${index}.to`} required error={(errors.step5?.military_details as any)?.[index]?.to?.message as string}>
                    <input type="date" {...register(`step5.military_details.${index}.to`)} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors [color-scheme:light]" />
                  </FormField>
                  <div className="md:col-span-2">
                    <FormField label="Breve descripción de funciones" name={`step5.military_details.${index}.duties`} required error={(errors.step5?.military_details as any)?.[index]?.duties?.message as string}>
                      <input {...register(`step5.military_details.${index}.duties`)} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors" />
                    </FormField>
                  </div>
                </div>
              )}
