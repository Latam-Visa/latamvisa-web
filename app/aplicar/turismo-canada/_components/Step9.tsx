    ...
    <div className="space-y-8">
      <div className="bg-[#F5F5F0] p-6 rounded-xl border border-[#E5E5E5] space-y-6">
        ...
        <FormField label="Estado Civil Actual" name="step9.marital_status" required error={errors.step9?.marital_status?.message as string}>
          <select {...register('step9.marital_status')} className="w-full bg-white border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] focus:ring-2 focus:ring-[#2F4A00] transition-colors appearance-none">
          ...
          <div className="bg-white p-6 rounded-xl border border-[#E5E5E5] space-y-4 animate-in fade-in slide-in-from-top-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <FormField label="Fecha de matrimonio / inicio de unión" name="step9.marriage_date" required error={errors.step9?.marriage_date?.message as string}>
                <input type="date" {...register('step9.marriage_date')} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors [color-scheme:light]" />
              </FormField>
              <FormField label="Apellidos de tu pareja" name="step9.spouse_surname" required error={errors.step9?.spouse_surname?.message as string}>
                <input {...register('step9.spouse_surname')} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors" />
              </FormField>
              <FormField label="Nombres de tu pareja" name="step9.spouse_given_name" error={errors.step9?.spouse_given_name?.message as string}>
                <input {...register('step9.spouse_given_name')} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors" />
              </FormField>
              <FormField label="Fecha de nacimiento" name="step9.spouse_date_of_birth" required error={errors.step9?.spouse_date_of_birth?.message as string}>
                <input type="date" {...register('step9.spouse_date_of_birth')} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors [color-scheme:light]" />
              </FormField>
              <FormField label="País de nacimiento" name="step9.spouse_birth_country" required error={errors.step9?.spouse_birth_country?.message as string}>
                <select {...register('step9.spouse_birth_country')} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors appearance-none">
              ...
              <FormField label="Ocupación actual" name="step9.spouse_occupation" required error={errors.step9?.spouse_occupation?.message as string}>
                <input {...register('step9.spouse_occupation')} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors" />
              </FormField>
            </div>
              ...
              renderItem={(index) => (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <FormField label="Apellidos" name={`step9.children.${index}.last_name`} required error={(errors.step9?.children as any)?.[index]?.last_name?.message as string}>
                    <input {...register(`step9.children.${index}.last_name`)} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors" />
                  </FormField>
                  <FormField label="Nombres" name={`step9.children.${index}.first_name`} required error={(errors.step9?.children as any)?.[index]?.first_name?.message as string}>
                    <input {...register(`step9.children.${index}.first_name`)} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors" />
                  </FormField>
                  <FormField label="Fecha de nacimiento" name={`step9.children.${index}.dob`} required error={(errors.step9?.children as any)?.[index]?.dob?.message as string}>
                    <input type="date" {...register(`step9.children.${index}.dob`)} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors [color-scheme:light]" />
                  </FormField>
                  <FormField label="Relación" name={`step9.children.${index}.relationship`} required error={(errors.step9?.children as any)?.[index]?.relationship?.message as string}>
                    <select {...register(`step9.children.${index}.relationship`)} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors appearance-none">
                  ...
                  <div className="md:col-span-2">
                    <FormField label="País de nacimiento" name={`step9.children.${index}.birth_country`} required error={(errors.step9?.children as any)?.[index]?.birth_country?.message as string}>
                      <select {...register(`step9.children.${index}.birth_country`)} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors appearance-none">
                        <option value="">Seleccionar país</option>
                        {ALL_COUNTRIES.map(c => <option key={c.code} value={c.code}>{c.flag} {c.name}</option>)}
                      </select>
                    </FormField>
      ...
      <div className="space-y-6">
        <RepeatableTable
          ...
          defaultItem={[
            { surname: '', given_name: '', relationship: 'Mother', dob: '', birth_country: '', occupation: '', address_same: '', country: '', street: '', city: '', accompany: '' },
            { surname: '', given_name: '', relationship: 'Father', dob: '', birth_country: '', occupation: '', address_same: '', country: '', street: '', city: '', accompany: '' }
          ]}
          minItems={2}
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <FormField label="Parentesco" name={`step9.parents.${index}.relationship`} required error={(errors.step9?.parents as any)?.[index]?.relationship?.message as string}>
        <select {...register(`step9.parents.${index}.relationship`)} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors appearance-none">
      ...
      <FormField label="Apellidos" name={`step9.parents.${index}.surname`} required error={(errors.step9?.parents as any)?.[index]?.surname?.message as string}>
        <input {...register(`step9.parents.${index}.surname`)} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors" />
      </FormField>
      <FormField label="Nombres" name={`step9.parents.${index}.given_name`} required error={(errors.step9?.parents as any)?.[index]?.given_name?.message as string}>
        <input {...register(`step9.parents.${index}.given_name`)} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors" />
      </FormField>
      ...
      <FormField label="Fecha de nacimiento" name={`step9.parents.${index}.dob`} required error={(errors.step9?.parents as any)?.[index]?.dob?.message as string}>
        <input type="date" {...register(`step9.parents.${index}.dob`)} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors [color-scheme:light]" />
      </FormField>
      <FormField label="País de nacimiento" name={`step9.parents.${index}.birth_country`} required error={(errors.step9?.parents as any)?.[index]?.birth_country?.message as string}>
        <select {...register(`step9.parents.${index}.birth_country`)} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors appearance-none">
          <option value="">Seleccionar país</option>
          {ALL_COUNTRIES.map(c => <option key={c.code} value={c.code}>{c.flag} {c.name}</option>)}
        </select>
      </FormField>
      ...
      <div className="md:col-span-2">
        <FormField label="Ocupación" hint="Si falleció, escribe 'Deceased'" name={`step9.parents.${index}.occupation`} required error={(errors.step9?.parents as any)?.[index]?.occupation?.message as string}>
          <input {...register(`step9.parents.${index}.occupation`)} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors" />
        </FormField>
      </div>
      ...
      {parentAddressSame === 'false' && (
        <>
          <FormField label="País de residencia" name={`step9.parents.${index}.country`} required error={(errors.step9?.parents as any)?.[index]?.country?.message as string}>
            <select {...register(`step9.parents.${index}.country`)} className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors appearance-none">
              <option value="">Seleccionar país</option>
          ...
          <FormField label="Ciudad" name={`step9.parents.${index}.city`} required error={(errors.step9?.parents as any)?.[index]?.city?.message as string}>
            <input {...register(`step9.parents.${index}.city`)} placeholder="O escribe 'Fallecido'" className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors" />
          </FormField>
          <div className="md:col-span-2">
            <FormField label="Dirección exacta" name={`step9.parents.${index}.street`} required error={(errors.step9?.parents as any)?.[index]?.street?.message as string}>
              <input {...register(`step9.parents.${index}.street`)} placeholder="O escribe 'Fallecido'" className="w-full bg-[#F5F5F0] border border-[#E5E5E5] rounded-lg px-4 py-3 text-[#0A0A0A] focus:outline-none focus:border-[#2F4A00] transition-colors" />
            </FormField>
          </div>
        </>
      )}
