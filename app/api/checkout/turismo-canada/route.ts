...
const PRECIO_BASE = 290 // AUD por persona
      ...
      line_items: [
        {
          price_data: {
            ...
            product_data: {
              name: aplicantes === 1
                ? 'Temporary Resident Visa (Canadá)'
                : `Temporary Resident Visa (Canadá) — ${aplicantes} aplicantes`,
              description: aplicantes >= 2
                ? `Asesoría completa y traducciones para ${aplicantes} personas (descuento ${Math.round(porcentajeDescuento * 100)}% aplicado)`
                : 'Asesoría completa y traducciones',
            },
