...
export default function TurismoJaponCheckoutPage() {
  ...
  return (
    <>
      <title>Visa Turismo Japón | Checkout Seguro</title>
      <meta name="description" content="Finaliza el pago de tu asesoría de visa de turismo a Japón." />
      ...
      <main className="min-h-screen lg:min-h-0 lg:h-screen lg:overflow-hidden bg-white text-[#111111] flex flex-col-reverse lg:flex-row w-full font-funnel selection:bg-[#111111] selection:text-[#C8FF00]">
        ...
        <section className="w-full lg:w-[45%] lg:h-screen lg:overflow-y-auto text-[#111111] border-b lg:border-b-0 lg:border-l border-[#C8FF00]/40 px-6 py-12 sm:px-10 lg:px-16 lg:py-16 relative bg-white/40 bg-gradient-to-br from-white/70 to-[#BC002D]/25 backdrop-blur-2xl">
