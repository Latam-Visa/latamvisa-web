    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          ...
          {renderRow('Ciudades a visitar', step4Travel.citiesToVisit as unknown as string)}
      ...
      <Page size="A4" style={styles.page}>
        <View style={styles.section}>
          ...
          {step5VisaHistory.hadPreviousUsaVisa === 'true' && (
            <>
              {renderRow('Visa anterior', step5VisaHistory.previousVisaNumber)}
              {renderRow('Emisión', step5VisaHistory.previousVisaIssueDate)}
            </>
          )}
        </View>
        ...
        <View style={styles.section}>
          ...
          {renderRow('Salario USD', step7Work.monthlySalaryUsd)}
          {renderRow('Educación más alta', step7Work.highestEducation)}
          {renderRow('Idiomas', step7Work.languages)}
        </View>

        <View style={styles.section}>
          <Text style={styles.sectionTitle}>8. Adicional e Imágenes</Text>
          {renderRow('Militar', step8Additional.militaryService)}
